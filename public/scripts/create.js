...
window.addEventListener("load", function (){
    ...
    let name = true, colorwave = true, brand_name = true, category = true, price = true, discount = false, release_year = true, story = true, images = true;
    ...
    document.querySelector("#item-images").addEventListener("change", function (){
        if (document.querySelector("#item-images").value == ""){
            document.querySelector(".item-images").classList.add("item-input-errors");
            document.getElementById("error-message-images").style.display = "block";
            document.getElementById("error-message-images").textContent = "Selecciona al menos una imagen";
            images = true;
        }else{
            document.querySelector(".item-images").classList.remove("item-input-errors");
    ...
    document.querySelector("#create-product-form").addEventListener("submit", function (event){
        // console.log(name, colorwave, brand_name, category, price, discount, release_year, story, size_30, size_35, size_40, size_45, size_50, size_55, size_60, size_65, size_70, size_75, size_80, size_85, size_90, size_95, size_100, size_105, size_110, size_115, size_120, size_125, size_130, size_135, size_140, size_145, size_150, size_155, images);
        if (name || colorwave || brand_name || category || price || discount || release_year || story || size_30 || size_35 || size_40 || size_50 ||
            ...
            size_120 || size_125 || size_130 || size_135 || size_140 || size_145 || size_150 || size_155 || images){
                ...
                if (price){
                    document.querySelector("#item-price").classList.add("item-input-errors");
                    document.getElementById("error-message-price").style.display = "block";
                    document.getElementById("error-message-price").textContent = "Este campo debe ser válido";
                }
                if (discount){
                    document.querySelector(".discount-container").classList.add("item-input-errors");
                    document.getElementById("error-message-discount").style.display = "block";
                    document.getElementById("error-message-discount").textContent = "Este campo debe ser válido";
                }
                if (release_year){
                    document.querySelector("#item-release_year").classList.add("item-input-errors");
                    document.getElementById("error-message-release_year").style.display = "block";
                    document.getElementById("error-message-release_year").textContent = "Este campo debe ser válido";
                }
                if (story){
                    document.querySelector(".description-container-parent").classList.add("item-input-errors");
                    document.getElementById("error-message-story").style.display = "block";
